...
//     use blobstream_sn::tree::namespace::hasher::{node_digest, leaf_digest};
//     use blobstream_sn::utils::{path_length_from_key, get_split_point};
...
//     // verify_multi_hashes(root : NamespaceNode, proof : NamespaceMerkleMultiproof, leaf_nodes: Array<NamespaceNode>) -> bool {
//     //     let mut leaf_index = 0;

//     //     let mut leaf_sub_trees: Array<NamespaceNode> = ArrayTrait::new();

//     //     let mut i = 0;
//     //     loop {
//     //         if(i== proof.side_nodes.len() && leaf_index == proof.begin_key) {
//     //             break;
//     //         }
//     //         let mut sub_tree_size = _next_sub_tree_size(leaf_index, proof.begin_key);
//     //         leaf_sub_trees.append(*proof.side_nodes.at(i));
...
//     //     // return namespace_node_eq(root, leaf_sub_trees.at(0));

//     // }

//     // fn pop_proof_if_non_empty(nodes : Array<NamespaceNode>, head: u256, end: u256, head_leaves : u256) -> (NamespaceNode, u256, bool) {
